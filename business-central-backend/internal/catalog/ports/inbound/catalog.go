...
type Catalog interface {
	...
	UploadProductImage(context.Context, *authdto.Claims, string, catalogdto.ImageUpload) (catalogdto.Image, error)
	UploadVariantImage(context.Context, *authdto.Claims, string, catalogdto.ImageUpload) (catalogdto.Image, error)
	UploadImage(context.Context, *authdto.Claims, string, catalogdto.ImageUpload) (catalogdto.Image, error)
