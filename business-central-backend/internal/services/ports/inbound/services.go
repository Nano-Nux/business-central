...
// Services is the inbound use-case port consumed by HTTP and other delivery
// adapters. It is intentionally independent from the outbound repository
// interface so adapters cannot depend on persistence contracts.
