...
CREATE TABLE merchants (
    ...
    ai_usage_limit INTEGER NOT NULL DEFAULT 50 CHECK (ai_usage_limit >= 0),
...
COMMENT ON TABLE merchant_custom_themes IS 'Merchant-scoped custom 5-color theme definitions available to merchant and its members.';
